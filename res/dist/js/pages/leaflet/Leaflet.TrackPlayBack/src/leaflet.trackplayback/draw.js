...
L.DrawPlayback = L.Class.extend({
  ...
  initialize: function (map, options) {
    ...
    this._trackLayer = new L.TrackLayer().addTo(map)
  ...
  _drawTrackPointsCanvas: function (trackpoints) {
    ...
    for (let i = 0, len = trackpoints.length; i < len; i++) {
      ...
      if (trackpoints[i].isOrigin) {
        ...
        // this._drawShipImage(trackpoints[i])
        ...
        // let myTriangleMarker = L.triangleMarker(latLng, {

        //     renderer:   renderer,   // your canvas renderer (default: L.canvas())

        //     rotation:   trackpoints[i].dir,         // triangle rotation in degrees (default: 0)

        //     width:      20,         // width of the base of triangle (default: 24)

        //     height:     20,          // height of triangle (default: 24)

        // })

        // // console.log(myTriangleMarker)
...
L.drawplayback = function (map, options) {

  return new L.DrawPlayback(map, options)
