 ...
 * 控制轨迹和绘制
 */
L.TrackController = L.Class.extend({
  ...
  addTrack: function (track) {
    ...
    } else if (track instanceof L.Track) {
...
L.trackController = function (tracks, draw, options) {
  return new L.TrackController(tracks, draw, options)
}
